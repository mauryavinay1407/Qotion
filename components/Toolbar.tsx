        ...
        <div className="pl-[54px] group relative">
            ...
            {!!initialData.icon && preview && ( 
                ...
                {isEditing && !preview ? (
                    ...
                    className="text-5xl bg-transparent font-bold break-words outilne-none text-[#3F3F3F] dark:text-[#CFCFCF] resize-none"
                    />
                ): (
                    <div
                    onClick={enableInput}
                    ...
                    outilne-none text-[#3F3F3F] dark:text-[#CFCFCF] "
                    >
                        {initialData.title}
                    </div>
                )}
